        ...
        <div className="cart-layout" style={{ maxWidth: 1400, margin: "0 auto", padding: "40px 32px", display: "grid", gridTemplateColumns: "1fr 380px", gap: 48 }}>
            ...
            {items.length === 0 ? (
              <div style={{ textAlign: "center", padding: "80px 20px" }}>
                ...
                <Link href="/collection"
                  style={{ display: "inline-block", padding: "14px 36px", background: "#111", color: "#fff", fontFamily: F, fontSize: 12, fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", textDecoration: "none", borderRadius: 50 }}>
                  Shop Now
                </Link>
              </div>
            ) : (
          ...
          <div>
            <div style={{ border: "1px solid var(--c-border)", padding: 28, position: "sticky", top: 80 }}>
              ...
              <Link href="/checkout"
                style={{ display: "block", width: "100%", padding: "16px 0", background: "#111", color: "#fff", textAlign: "center", fontFamily: FO, fontSize: 13, fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", textDecoration: "none", transition: "background 0.2s, box-shadow 0.2s", marginBottom: 12, borderRadius: 50 }}
