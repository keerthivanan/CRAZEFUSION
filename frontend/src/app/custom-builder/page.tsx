    ...
    <div style={{ background: "#fff", minHeight: "100vh" }}>
      ...
      <main style={{ paddingTop: 64 }}>
        ...
        <div style={{ background: "var(--c-bg-soft)", borderBottom: "1px solid var(--c-border)", padding: "48px 32px", textAlign: "center" }}>
          ...
          <h1 style={{ fontFamily: FE, fontSize: "clamp(32px,5vw,64px)", fontWeight: 400, color: "var(--c-text)", textTransform: "uppercase", letterSpacing: "-0.04em", marginBottom: 12 }}>Custom Poster Builder</h1>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "48px 32px" }}>
          ...
          <div style={{ marginBottom: 48 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 24 }}>
              <div style={{ width: 32, height: 32, background: "#111", color: "#fff", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: FE, fontSize: 14, fontWeight: 400, flexShrink: 0 }}>1</div>
              <h2 style={{ fontFamily: FE, fontSize: 22, fontWeight: 400, color: "var(--c-text)", textTransform: "uppercase", letterSpacing: "-0.02em", margin: 0 }}>Choose Your Layout</h2>
            </div>
              ...
              {layouts.map(l => (
                <button key={l.id} onClick={() => setSelectedLayout(l.id)}
                  ...
                  <div style={{ padding: "10px 12px", textAlign: "left" }}>
                    <div style={{ fontFamily: FE, fontSize: 12, fontWeight: 500, color: selectedLayout === l.id ? "#111" : "#555", textTransform: "uppercase", marginBottom: 2 }}>{l.label}</div>
          ...
          <div style={{ marginBottom: 48 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 24 }}>
              <div style={{ width: 32, height: 32, background: "#111", color: "#fff", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: FE, fontSize: 14, fontWeight: 400, flexShrink: 0 }}>2</div>
              <h2 style={{ fontFamily: FE, fontSize: 22, fontWeight: 400, color: "var(--c-text)", textTransform: "uppercase", letterSpacing: "-0.02em", margin: 0 }}>Upload Your Photo</h2>
            </div>
            <label
              ...
              {uploadedFile ? (
                <div>
                  ...
                  <div style={{ fontFamily: FE, fontSize: 16, fontWeight: 500, color: "#16a34a", marginBottom: 8 }}>✓ Photo Uploaded!</div>
                  <div style={{ fontFamily: F, fontSize: 12, color: "#aaa" }}>Click to change photo</div>
                </div>
              ) : (
                <div>
                  <div style={{ fontFamily: FE, fontSize: 18, fontWeight: 500, color: "var(--c-text)", textTransform: "uppercase", marginBottom: 8 }}>Drag & Drop your photo here</div>
                  <div style={{ fontFamily: F, fontSize: 13, color: "#aaa", marginBottom: 16 }}>or click to browse files</div>
                  <div style={{ display: "inline-block", padding: "10px 24px", background: "#111", color: "#fff", fontFamily: F, fontSize: 11, fontWeight: 500, letterSpacing: "0.1em", textTransform: "uppercase" }}>Choose File</div>
          ...
          <div style={{ marginBottom: 48 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 24 }}>
              <div style={{ width: 32, height: 32, background: "#111", color: "#fff", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: FE, fontSize: 14, fontWeight: 400, flexShrink: 0 }}>3</div>
              <h2 style={{ fontFamily: FE, fontSize: 22, fontWeight: 400, color: "var(--c-text)", textTransform: "uppercase", letterSpacing: "-0.02em", margin: 0 }}>Size & Finish</h2>
            </div>
          ...
          <div style={{ background: "var(--c-bg-soft)", border: "1px solid var(--c-border)", padding: 32 }}>
            <h3 style={{ fontFamily: FE, fontSize: 20, fontWeight: 400, color: "var(--c-text)", textTransform: "uppercase", marginBottom: 20 }}>Your Custom Poster</h3>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16, marginBottom: 24 }}>
              {[["Layout", layout.label], ["Size", sizes[selectedSize]], ["Finish", finishes[selectedFinish]], ["Delivery", "5–7 Business Days"]].map(([label, val]) => (
                <div key={label as string}>
                  ...
                  <div style={{ fontFamily: FE, fontSize: 16, fontWeight: 500, color: "var(--c-text)" }}>{val as string}</div>
                </div>
              ))}
            </div>
            <div style={{ display: "flex", gap: 16, alignItems: "center", flexWrap: "wrap" }}>
              <div>
                ...
                <div style={{ fontFamily: FE, fontSize: 28, fontWeight: 400, color: "var(--c-text)" }}>₹149</div>
              </div>
              <Link href="/cart"
                style={{ flex: 1, minWidth: 200, padding: "16px 32px", background: "#111", color: "#fff", fontFamily: F, fontSize: 13, fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", textDecoration: "none", textAlign: "center", display: "block", transition: "background 0.2s" }}
