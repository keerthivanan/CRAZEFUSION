    ...
    <div style={{ background: "var(--c-bg)", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 32px" }}>
        ...
        {partner.status === "pending" && (
          <div style={{ padding: "16px 20px", background: "var(--c-bg-soft)", border: "1px solid var(--c-border)", borderRadius: 4, marginBottom: 32, fontFamily: FO, fontSize: 13, color: "var(--c-text-muted)" }}>
        ...
        {tab === "designs" && (
          designs.length === 0
            ? <div style={{ textAlign: "center", padding: "64px 32px", color: "#aaa", fontFamily: FO, fontSize: 13 }}>
                No designs yet.{" "}
                <button onClick={() => setTab("upload")} style={{ color: "var(--c-text)", background: "none", border: "none", cursor: "pointer", fontFamily: FO, fontSize: 13, textDecoration: "underline" }}>Upload your first design →</button>
              </div>
