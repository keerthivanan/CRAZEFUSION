        ...
        <nav style={{
          ...
          <div style={{
            ...
            <Link href="/" style={{ position: "absolute", left: "50%", top: "50%", transform: "translate(-50%,-50%)", textDecoration: "none" }}>
              <img src="/logo.png" alt="CrazeFusion" className="nav-logo-desktop" style={{ height: 52, width: "auto", objectFit: "contain", display: "block", filter: theme === "dark" ? "invert(1)" : "none", transition: "filter 0.2s" }} />
              <img src="/cf_mobile.png" alt="CrazeFusion" className="nav-logo-mobile" style={{ height: 36, width: "auto", objectFit: "contain", display: "none", filter: theme === "dark" ? "invert(1)" : "none", transition: "filter 0.2s" }} />
            </Link>
