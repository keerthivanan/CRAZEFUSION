      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 40px" }} className="why-inner">
        ...
        <AnimatedContent distance={20} duration={0.5}>
          <div style={{
            ...
            <div>
              <div style={{ fontFamily: FO, fontSize: 10, fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--c-text-muted)", marginBottom: 12 }}>
                Why Choose Us
              </div>
          ...
          {features.map(({ num, title, desc }, i) => (
            <AnimatedContent key={title} distance={16} delay={i * 0.1} duration={0.5} threshold={0.05}>
              ...
              >
                ...
                <div style={{ width: 28, height: 2, background: "var(--c-border)", marginBottom: 20 }} />
