...
function ReviewCard({ r }: { r: typeof reviews[0] }) {
  return (
    <div style={{
      ...
      {/* Gold accent bar */}
      <div style={{ position: "absolute", top: 0, left: 0, width: 3, height: "100%", background: "var(--c-text)", borderRadius: "12px 0 0 12px" }} />

      {/* Stars */}
      <div style={{ color: "var(--c-text)", fontSize: 14, letterSpacing: 2, marginBottom: 14 }}>★★★★★</div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ fontFamily: FO, fontSize: 9, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--c-text-muted)", background: "var(--c-bg-soft)", border: "1px solid var(--c-border)", padding: "4px 10px", borderRadius: 20 }}>
          {r.product}
        </div>
      </div>
    </div>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 32px 56px", display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 24 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{ color: "var(--c-text)", fontSize: 20, letterSpacing: 4, marginTop: 4 }}>★★★★★</div>
