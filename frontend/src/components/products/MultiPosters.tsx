...
function MultiCard({ p }: { p: typeof products[0] }) {
  ...
  return (
    <div className="mp-card" style={{ flexShrink: 0, width: 260, scrollSnapAlign: "start" }}>
      <div
        ...
        onMouseEnter={e => {
          ...
          const btn = e.currentTarget.querySelector(".mp-btn") as HTMLElement;
      ...
      >
        ...
        <div className="mp-btn" style={{ position: "absolute", bottom: 0, left: 0, right: 0, opacity: 0, transform: "translateY(10px)", transition: "all 0.25s ease" }}>
          <ClickSpark sparkColor="#fff" sparkCount={8} sparkRadius={20}>
            <button onClick={handleQuickAdd}
              style={{ width: "100%", padding: "13px 0", background: "rgba(10,10,10,0.92)", backdropFilter: "blur(4px)", color: "#fff", fontFamily: FO, fontSize: 11, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", border: "none", cursor: "pointer", borderRadius: 50 }}>
              Quick Add
            </button>
          </ClickSpark>
        </div>
