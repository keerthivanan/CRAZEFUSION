    ...
    <section style={{ background: "var(--c-bg)", padding: "0 0 0 0" }}>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "48px 40px 24px" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          <div>
            <div style={{ fontFamily: FO, fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--c-text-muted)", marginBottom: 6 }}>
              Shop by Sport
            </div>
        ...
        {sports.map((sport) => (
          ...
          >
            ...
            <div style={{
              ...
              <div>
                <div style={{ fontFamily: FO, fontSize: 9, fontWeight: 600, letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--c-text-muted)", marginBottom: 4 }}>
                  {sport.count}
                </div>
