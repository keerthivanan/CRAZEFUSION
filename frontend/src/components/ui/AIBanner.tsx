    ...
    <section style={{ background: "#080808", padding: "80px 0 96px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 40px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center", marginBottom: 64 }} className="ai-banner-grid">
          <div>
            <div style={{ fontFamily: FO, fontSize: 10, fontWeight: 700, letterSpacing: "0.25em", textTransform: "uppercase", color: "#e8a000", marginBottom: 20 }}>
              AI Studio
            </div>
            <h2 style={{ fontFamily: FO, fontSize: "clamp(32px,4.5vw,60px)", fontWeight: 800, letterSpacing: "-0.03em", color: "#fff", textTransform: "uppercase", margin: "0 0 20px", lineHeight: 1 }}>
              Every Poster.<br />
              <span style={{ background: "linear-gradient(135deg,#e8a000,#fff176)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                Your Way.
              </span>
            </h2>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <Link href="/create" style={{ display: "inline-block", padding: "14px 32px", background: "#e8a000", color: "#000", fontFamily: FO, fontSize: 11, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase", textDecoration: "none", borderRadius: 50, transition: "transform 0.2s, box-shadow 0.2s", boxShadow: "0 0 32px rgba(232,160,0,0.25)" }}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2, background: "rgba(255,255,255,0.04)", borderRadius: 20, overflow: "hidden", border: "1px solid rgba(255,255,255,0.06)" }}>
            {STEPS.map((s, i) => (
              <div key={i} style={{ padding: "32px 28px", background: "rgba(255,255,255,0.02)", transition: "background 0.2s" }}
                onMouseEnter={e => (e.currentTarget as HTMLDivElement).style.background = "rgba(232,160,0,0.05)"}
                ...
                <div style={{ width: 24, height: 2, background: "#e8a000", marginBottom: 14 }} />
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          {[{ name: "Starter", price: "£2.99", credits: "30 credits" }, { name: "Creator", price: "£7.99", credits: "100 credits" }, { name: "Pro", price: "£14.99", credits: "250 credits" }].map((p, i) => (
            <Link key={i} href="/credits" style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 20px", background: i === 1 ? "rgba(232,160,0,0.08)" : "rgba(255,255,255,0.03)", border: `1px solid ${i === 1 ? "rgba(232,160,0,0.25)" : "rgba(255,255,255,0.07)"}`, borderRadius: 12, textDecoration: "none", transition: "all 0.2s" }}
              onMouseEnter={e => (e.currentTarget as HTMLAnchorElement).style.background = "rgba(232,160,0,0.1)"}
              onMouseLeave={e => (e.currentTarget as HTMLAnchorElement).style.background = i === 1 ? "rgba(232,160,0,0.08)" : "rgba(255,255,255,0.03)"}>
              <span style={{ fontFamily: FO, fontSize: 13, fontWeight: 700, color: i === 1 ? "#e8a000" : "rgba(255,255,255,0.5)" }}>{p.price}</span>
