    ...
    <section style={{ background: "var(--c-bg-soft)", padding: "88px 32px" }} className="newsletter-section">
      <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
        ...
        <div style={{
          ...
          <span style={{ width: 6, height: 6, borderRadius: "50%", background: "var(--c-text)" }} />
          <span style={{ fontFamily: FO, fontSize: 10, fontWeight: 600, letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--c-text-muted)" }}>
