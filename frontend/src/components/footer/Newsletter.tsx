        ...
        {done ? (
          ...
          <form onSubmit={e => { e.preventDefault(); if (email) setDone(true); }}
            ...
            <ClickSpark sparkColor="#e8a000" sparkCount={8} sparkRadius={20}>
              <button type="submit" style={{ padding: "14px 24px", background: "#111", color: "#fff", fontFamily: FO, fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", border: "none", cursor: "pointer", whiteSpace: "nowrap", transition: "background 0.2s", borderRadius: 50 }}
